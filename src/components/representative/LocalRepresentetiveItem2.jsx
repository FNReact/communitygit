...
const LocalRepresentetiveItem2 = ({ representative, handleDeleteRepresentetive }) => {
    ...
    console.log(representative , 'representive Details');
    ...
    return (
        <Fragment>
            ...
            <div className="resource_item_2 representative_item_2 cursorPointer" >
                ...
                {representative && representative?.details && <div className="card_details" onClick={(e) => navigate('/representative-details', { state: { uuid: representative.uuid, userRecommended: userRecommended } })}>{parser(representative.details.slice(0, 30))}</div>}
