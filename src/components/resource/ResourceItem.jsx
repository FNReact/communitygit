...
const ResourceItem = ({data,admin, getAllResouces}) => { 
          ...
          <Menu
            ...
            <div className="dropdown_menuTab">
                <ul>
                    ...
                    <li onClick={(e)=>{handleDeleteResource(data.uuid);handleClose()} }> Delete Resource </li>
                </ul>
            </div>
          </Menu>
            <div className="resource_item">
              <div className="resource_item_top">
              {data && data.title &&  <div className="resource_title" onClick={(e)=>navigate('/resource-details', {state:{uuid:data.uuid}})}>{data.title.slice(0,22)}..</div>}
              ...
              {data && data.details && <div className="resource_item_details" onClick={(e)=>navigate('/resource-details', {state:{uuid:data.uuid}})}>{parser(data.details.slice(0,120))} ...</div>}
