              ...
              <Grid container spacing={2}>
                 ...
                 <Grid item xs={12}>
                    <div className="input_field">
                       <input type="text" className="form_cotrol" placeholder="Event Title" onChange={(e)=>setValue ("title",e.target.value)} value={values.title} />
                    </div>
                 </Grid>
                 <Grid item xs={12}>
                     <div className="input_field">
                       <input type="text" className="form_cotrol" placeholder="Sub Title" onChange={(e)=>setValue ("subtitle",e.target.value)} value={values.subtitle} />
                    </div>
                 </Grid>
                 <Grid item xs={12}>
                     <div className="input_field">
                       <input type="text" className="form_cotrol" placeholder="Location" onChange={(e)=>setValue ("location",e.target.value)} value={values.location} />
                    </div>
                 </Grid>
                 <Grid item xs={12}>
                     <div className="input_field">
                       <input type="text" className="form_cotrol" placeholder={`Venue${' '}(Google Map Direction URL)`} onChange={(e)=>setValue ("directionUrl",e.target.value)} value={values.directionUrl} />
                    </div>
                 </Grid>
